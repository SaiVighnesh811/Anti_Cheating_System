...
const violationLogSchema = new mongoose.Schema({
  ...
  type: { type: String, enum: ['TAB_SWITCH', 'FULLSCREEN_EXIT', 'MINIMIZE', 'tab-switch', 'window-blur', 'multiple-login', 'terminated', 'fullscreen-exit', 'COPY_ATTEMPT', 'DEVTOOLS_OPEN', 'RIGHT_CLICK'], required: true },
