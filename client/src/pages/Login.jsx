    ...
    <div className="login-background" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
      <div className="glass-panel" style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <h1 style={{ margin: 0, fontSize: '2.25rem', fontWeight: '800', color: 'var(--text-primary)', letterSpacing: '-0.04em' }}>Welcome Back</h1>
          <p style={{ color: 'var(--text-secondary)', marginTop: '0.5rem', fontWeight: '500' }}>Access your secure examination portal</p>
        </div>
          ...
          <div className="input-group">
            ...
            <div style={{ position: 'relative' }}>
              <input 
                ...
                required
                style={{ width: '100%', padding: '1rem 3.5rem 1rem 1.25rem', borderRadius: '12px', border: '1.5px solid #e2e8f0', fontSize: '1rem', transition: 'all 0.2s ease' }}
              />
              <button 
                type="button" 
        ...
        <div style={{ textAlign: 'center', marginTop: '2.5rem', fontSize: '0.95rem', color: 'var(--text-secondary)', fontWeight: '500' }}>
          New candidate? <Link to="/register" style={{ color: 'var(--primary)', fontWeight: '700', textDecoration: 'none' }}>Initialize Account</Link>
        </div>
      </div>
    </div>
  );
